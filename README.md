...
## 【注意】
1. 可自行在``设置``或**arXivPaperReader**文件夹下的``.env``文件配置模型/翻译api，当前仅测试过deepseek和百度，测试通过
2. 访问arXiv不要太频繁，api有频率限制（默认3.1秒间隔），以及最好白天使用，晚上阿美利卡人起床了
3. 目前在测试使用大模型批量分析论文的功能时，只进行了小批次测试，问就是苯人抠门，大量批次处理结果未知
## 【使用方式】
1. 下载zip文件后解压，点击.exe文件运行程序
